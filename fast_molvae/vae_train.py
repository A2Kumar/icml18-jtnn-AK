...
parser.add_argument('--step_beta', type=float, default=0.004)
parser.add_argument('--max_beta', type=float, default=0.4)
parser.add_argument('--warmup', type=int, default=2000)

parser.add_argument('--epoch', type=int, default=20)
parser.add_argument('--anneal_rate', type=float, default=0.9)
parser.add_argument('--anneal_iter', type=int, default=2000)
parser.add_argument('--kl_anneal_iter', type=int, default=50)
